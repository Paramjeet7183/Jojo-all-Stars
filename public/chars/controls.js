function controls(player,data,enemyPos){
    ...
    onKeyDown("left", () => {
        player.flipX(true)
        isFlip = true;
        if(!isKeyDown("d") && !isKeyPressed("d") && !isKeyDown("a") && !isKeyPressed("a")&& !isKeyDown("s") && !isKeyPressed("s")&& !isKeyDown("w") && !isKeyPressed("w")){
    ...
    onKeyDown("down",()=>{
        if(!isKeyDown("d") && !isKeyPressed("d") && !isKeyDown("a") && !isKeyPressed("a")&& !isKeyDown("s") && !isKeyPressed("s")){
            player.play("crouch")
        }
    })
